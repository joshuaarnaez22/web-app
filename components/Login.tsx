  ...
  return (
    <Flex w='100%' h='100vh'>
      <Box
        ...
        bg='white'
        h='100%'
        bgGradient='linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 0%, rgba(85,195,255,1) 70%, rgba(1,198,246,1) 95%, rgba(0,212,255,1) 100%);'
      >
        <Flex boxShadow='md' rounded='md' maxW='500px' mx='auto' mt='90px' bg='#3b9ae3' direction='column' p='10' gap='4'>
          ...
          <Button bg='blue' borderRadius='20px' border='none'>
            Login
          </Button>
        </Flex>
      </Box>
